#' @title Graphics parameters for plotting
#' @export
...
seasonality_types_labels <- c(
    "No seasonality"                    = "NO_SEASONALITY",
    "Precipitation"                     = "PREC",
...
harvest_rule_labels <- paste(rep(c("t-low", "t-mid", "t-high"), each = 3),
                             rep(c("no-seas", "prec-seas", "mix-seas"), times = 3), sep = "_")
...
#                            "w. lim", "mid. t.", "high t.")
harvest_reason_labels <- c("hd_first", "hd_maxrp", "hd_last",
...
harvest_reason_cols <- c("#d9f0d3", "#7fbf7b", "#1b7837",
                         "#d95f02", "#af8dc3", "#762a83")
